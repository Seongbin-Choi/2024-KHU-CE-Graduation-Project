...
Original file is located at
    https://colab.research.google.com/drive/1ucI_BAkN1NuJd86o58enSSg3u-O3fomX
"""
...
while current_date <= datetime.strptime(end_date, '%Y-%m-%d'):
    ...
    try:
        ...
        X_train, X_test, y_train, y_test = train_test_split(combined_data[:, :-1], combined_data[:, -1], test_size=0.1, random_state=42)
        model.fit(X_train, y_train, epochs=epochs, batch_size=batch_size, verbose=0)  # 예측시에는 epoch을 줄일 수 있음
...
plt.xlabel('Date')
plt.ylabel('Price')
plt.title('SS Actual Prices vs. Predictions (Without Exchange Rate)')
